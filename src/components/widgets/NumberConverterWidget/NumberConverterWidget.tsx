      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="space-y-2">
          <input
            ...
            className={`w-full px-3 sm:px-4 py-2 sm:py-3 text-base sm:text-lg border rounded-lg bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 placeholder-neutral-500 dark:placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200 ${
              inputError
        ...
        {convertedParts.length > 0 && (
          <div className="space-y-4">
            <div className="bg-gradient-to-r from-primary-50 to-accent-50 dark:from-primary-900/20 dark:to-accent-900/20 rounded-xl p-3 sm:p-4 md:p-6 border border-primary-100 dark:border-primary-800">
            ...
            {/* Color Legend */}
            <div className="bg-neutral-50 dark:bg-neutral-800 rounded-lg p-3 sm:p-4 border border-neutral-200 dark:border-neutral-700">
