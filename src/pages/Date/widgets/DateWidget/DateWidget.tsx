      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="relative">
          ...
          <div
            ...
            className="w-full px-3 sm:px-4 py-2 sm:py-3 text-base sm:text-lg border border-neutral-300 dark:border-neutral-600 rounded-lg bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 cursor-pointer hover:bg-neutral-50 dark:hover:bg-neutral-750 transition-colors duration-200 group"
          >
