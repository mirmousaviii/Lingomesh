...
const Declension: React.FC<DeclensionProps> = ({ language }) => {
  ...
  return (
    <PageLayout>
        ...
        <Box
          ...
          headerColor={
            type.color.includes("blue")
              ...
              ? "orange"
              : type.color.includes("pink")
              ? "pink"
              : type.color.includes("teal")
              ? "teal"
              : type.color.includes("emerald")
              ? "emerald"
              : "primary"
          }
        >
      ...
      {/* Adjective Endings Table */}
      <Box
        title={isGerman ? "Adjektivendungen" : "Adjective Endings"}
        description={
          isGerman
      ...
      {/* Common Adjectives */}
      <Box
        title={isGerman ? "Häufige Adjektive" : "Common Adjectives"}
        description={
          isGerman
      ...
      {/* Practice Section */}
      <Box
        title={isGerman ? "Deklinationen üben" : "Practice Declensions"}
        description={
          isGerman
